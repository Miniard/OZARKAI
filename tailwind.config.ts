  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'primary-glow': '0 4px 14px 0 rgba(59, 130, 246, 0.25)',
        'primary-glow-lg': '0 8px 25px 0 rgba(59, 130, 246, 0.3)',
        'card': '0 1px 3px 0 rgba(0, 0, 0, 0.04), 0 1px 2px -1px rgba(0, 0, 0, 0.04), 0 0 0 1px rgba(0, 0, 0, 0.03)',
        'card-hover': '0 8px 25px -5px rgba(0, 0, 0, 0.08), 0 0 0 1px rgba(59, 130, 246, 0.1)',
      },
      fontFamily: {
